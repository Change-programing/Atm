...
public class ContactActivity extends AppCompatActivity {
    ...
    private void readContacts() {
        ...
        Cursor cursor = getContentResolver().query(ContactsContract.Contacts.CONTENT_URI,
                null,null,null,null);
        //ContactsContract裡面的Contacts內部類別 projection查詢你想要多少欄位
        ...
        while(cursor.moveToNext()){
            ...
            int hasPhone = cursor.getInt(
                    cursor.getColumnIndex(ContactsContract.Contacts.HAS_PHONE_NUMBER));//ctrl+Q顯示文件資料
            ...
            if (hasPhone == 1){
                Cursor c2 = getContentResolver().query(ContactsContract.CommonDataKinds.Phone.CONTENT_URI,
                        ...
                        null);//等號問號代表WHERE CONTACT_ID等於問號
                while (c2.moveToNext()){
